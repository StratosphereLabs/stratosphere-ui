import{j as t}from"./jsx-runtime-DiklIkkE.js";import{r as s}from"./index-DRjF_FHU.js";import{C as n,f as Z,a as $,b as ee}from"./Calendar-B2W5v6ym.js";import"./index-lhGYx47h.js";import"./useValueChangeEffect-DgF92LoJ.js";import"./lodash-C1F-7-Ro.js";import"./Icons-B4n3P6JJ.js";const ue={title:"Calendar",component:n},l={render:()=>{const[e,a]=s.useState(new Date);return t.jsxs("div",{className:"flex flex-col items-center gap-2",children:[t.jsx(n,{mode:"single",onChange:a,value:e}),t.jsx("span",{className:"text-sm opacity-60",children:e!==null?Z(e):"No date selected"})]})}},u={render:()=>{const[e,a]=s.useState(new Date);return t.jsxs("div",{className:"flex flex-col items-center gap-2",children:[t.jsx(n,{mode:"datetime",onChange:a,value:e}),t.jsx("span",{className:"text-sm opacity-60",children:e!==null?$(e):"No date selected"})]})}},c={render:()=>{const[e,a]=s.useState(new Date);return t.jsx(n,{mode:"datetime",onChange:a,showSeconds:!0,timeLabel:"Departure time",value:e})}},o={render:()=>{const[e,a]=s.useState({from:null,to:null});return t.jsxs("div",{className:"flex flex-col items-center gap-2",children:[t.jsx(n,{mode:"range",onChange:a,value:e}),t.jsx("span",{className:"text-sm opacity-60",children:[e.from,e.to].map(r=>r!==null?Z(r):"…").join(" – ")})]})}},d={render:()=>{const[e,a]=s.useState(new Date(2013,7,1));return t.jsxs("div",{className:"flex flex-col items-center gap-2",children:[t.jsx(n,{mode:"month",onChange:a,value:e}),t.jsx("span",{className:"text-sm opacity-60",children:e!==null?ee(e):"No month selected"})]})}},m={render:()=>{const e=new Date,[a,r]=s.useState(e);return t.jsx(n,{max:new Date(e.getFullYear(),e.getMonth(),20),min:new Date(e.getFullYear(),e.getMonth(),5),onChange:r,value:a})}},i={render:()=>{const[e,a]=s.useState(null);return t.jsx(n,{isDateDisabled:r=>[0,6].includes(r.getDay()),onChange:a,value:e})}},p={render:()=>{const[e,a]=s.useState(new Date);return t.jsx(n,{captionLayout:"dropdown",onChange:a,value:e})}},v={render:()=>{const[e,a]=s.useState(new Date);return t.jsx(n,{onChange:a,showWeekNumber:!0,value:e})}},g={render:()=>{const[e,a]=s.useState(new Date);return t.jsx(n,{onChange:a,value:e,weekStartsOn:1})}},h={render:()=>{const[e,a]=s.useState(new Date);return t.jsx(n,{footer:t.jsx("div",{className:"flex justify-end",children:t.jsx("button",{className:"btn btn-ghost btn-xs",onClick:()=>a(null),type:"button",children:"Clear"})}),onChange:a,value:e})}};var x,D,S;l.parameters={...l.parameters,docs:{...(x=l.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: () => {
